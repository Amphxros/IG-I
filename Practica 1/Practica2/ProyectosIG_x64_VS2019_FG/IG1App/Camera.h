...
protected:
	...
	glm::dvec3 mRight = { 0.0, 0.0, 500.0 };  // camera's position
	glm::dvec3 mUpward = { 0.0, 0.0, 0.0 };   // target's position
	...
	GLdouble xRight, xLeft, yTop, yBot, mAng,mRadio;      // size of scene visible area
